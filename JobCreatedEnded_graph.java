...
public class JobCreatedEnded_graph extends Application {
    ...
    @Override public void start(Stage stage) {
        stage.setTitle("Job Created and Completed ");
        final CategoryAxis xAxis = new CategoryAxis();
        final NumberAxis yAxis = new NumberAxis();
        final BarChart<String,Number> bc = 
            new BarChart<String,Number>(xAxis,yAxis);
        bc.setTitle("Job Created and Completed Summary");
        xAxis.setLabel("month");       
        yAxis.setLabel("Number of job");
 
        XYChart.Series series1 = new XYChart.Series();
        series1.setName("Job created");       
        series1.getData().add(new XYChart.Data("June", JuneStart));
        series1.getData().add(new XYChart.Data("July",JulyStart ));
        series1.getData().add(new XYChart.Data("August", AugStart));
        series1.getData().add(new XYChart.Data("September", SeptStart));
        series1.getData().add(new XYChart.Data("October", OctStart));      
        series1.getData().add(new XYChart.Data("November", NovStart));      
        series1.getData().add(new XYChart.Data("December", DecStart));      
        
        XYChart.Series series2 = new XYChart.Series();
        series2.setName("Job Completed");
